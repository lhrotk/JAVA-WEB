package com.ututor.entity;

public class CourseListUnit {
	int class_id;
	int type;
	String course_code;
	String launcher;
	...
	public int getPast_attendant() {
		return past_attendant;
	}
	public void setPast_attendant(int past_attendant) {
		this.past_attendant = past_attendant;
	}
